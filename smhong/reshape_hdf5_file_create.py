...
output_file = 'E:/smhong/micai_ai_challange/dataset/ECG_adult_numpy_train.h5'  # 저장할 hdf5 파일 이름
...
# HDF5 파일 생성확인
file_exists = os.path.exists('E:/smhong/micai_ai_challange/dataset/ECG_adult_numpy_train.h5')
print(file_exists)