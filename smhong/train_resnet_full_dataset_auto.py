...
train_datasets = ['ecg_adult_data6.npz', 'ecg_adult_data4.npz', 'ecg_adult_data3.npz', 'ecg_adult_data2.npz','ecg_adult_data1.npz', 'ecg_adult_data0.npz', 'ecg_child_data0.npz']  # , 'ecg_child_data1.npz']
y_train_datasets = ['y_adult_train6.npz', 'y_adult_train4.npz', 'y_adult_train3.npz', 'y_adult_train2.npz','y_adult_train1.npz', 'y_adult_train0.npz', 'y_child_train0.npz']  # ,'y_child_train1.npz']
valid_datasets = ['ecg_adult_data5.npz', 'ecg_child_data1.npz']
y_valid_datasets = ['y_adult_train5.npz', 'y_child_train1.npz']
...
# train_datasets_grouped = train_datasets_grouped[20:]
# y_train_datasets_grouped = y_train_datasets_grouped[20:]
...
for i, (train_group, y_train_group) in enumerate(zip(train_datasets_grouped, y_train_datasets_grouped)):
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_train_adult, y_train_adult_encoded, test_size=0.1,
                                                        random_state=42)
    train_dset = tf.data.Dataset.from_tensor_slices((x_train, y_train)).shuffle(buffer_size=len(x_train)).batch(
        BATCH_SIZE)
