...
ecg_adult_data_path = glob.glob("E:/smhong/micai_ai_challange/dataset/ECG_adult_numpy_vaild/ecg_adult_*.npy")
...
for i in range(len(npy_files)):
    file_path = "E:/smhong/micai_ai_challange/dataset/ECG_adult_numpy_vaild/" + str(npy_files[i])
...
# np.savez('ecg_adult_valid.npz', ecg_adult_data_array=ecg_adult_data_array)
#
